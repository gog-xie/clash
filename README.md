...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.2 重点推荐两个类型版本，一个是采用mihomo内置GEO数据库，另一个是采用的[MetaCubeX大佬实时更新的GEO数据库](https://github.com/gog-xie/meta-rules-dat/tree/meta/geo)，配置中内置了分区域节点的smart智能选择、自动选择、手动选择、故障转移、负载均衡等功能，仅需修改yaml文件中的机场地址和名称即可。
