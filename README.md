...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.1 配置模板最多采用了五层策略规则，层次功能分明，故转层负责检测和确保节点可用，地区策略层负责节点选择的形式（均衡、自动、smart、手动），即故转-手动→全球手动→地区策略→均衡or自动（或smart）or手动→节点，“全球手动”可自定义选择喜欢的地区策略或单一节点，当"全球手动"的节点失联时，自动切换至可用节点，闲时几乎不产生代理流量，响应迅速，可实现长时免维护。
...
| <div align="center">**3**</div> | 📄**GeoSmartAIO.yaml** | <div align="center">★★★</div> | <div align="center">[跳转](yaml/GeoSmartAIO.yaml)</div> | 采用内置Geo数据库，适配Smart核心 |
| <div align="center">**4**</div> | 📄**RuleAIO.yaml** | <div align="center">★★★☆</div> | <div align="center">[跳转](yaml/RuleAIO.yaml)</div> | 采用官方实时更新Geo数据库，五层策略 |
| <div align="center">**5**</div> | 📄**RuleAIOPlus.yaml** | <div align="center">★★★★★</div> | <div align="center">[跳转](yaml/RuleAIOPlus.yaml)</div> | 采用官方实时更新Geo数据库，自定义出站机场，强化故转 |
| <div align="center">**6**</div> | 📄**RuleAIOPro.yaml** | <div align="center">★★★★</div> | <div align="center">[跳转](yaml/RuleAIOPro.yaml)</div> | 采用官方实时更新Geo数据库，自定义出站机场 |
| <div align="center">**7**</div> | 📄**RuleLite.yaml** | <div align="center">★★★</div> | <div align="center">[跳转](yaml/RuleLite.yaml)</div> | 采用官方实时更新Geo数据库，极简分流
| <div align="center">**8**</div> | 📄**RuleSmartAIO.yaml** | <div align="center">★★★☆</div> | <div align="center">[跳转](yaml/RuleSmartAIO)</div> | 采用官方实时更新Geo数据库，适配Smart核心 |
</div>
